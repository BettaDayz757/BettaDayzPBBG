...
export const meta: MetaFunction = () => {
  return [
    ...
    { name: "description", content: "Build your business empire in Norfolk, VA. A life simulation game combining elements of BitLife, IMVU, and Torn.com." },
          ...
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex items-center space-x-4">
              <div className="text-sm text-gray-500">
                Build your legacy in Norfolk, VA
              </div>
            </div>
          </div>
        </div>
      ...
      <footer className="bg-white border-t mt-12">
        <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center">
            <div className="text-sm text-gray-500">
              © 2024 BettaDayz. Building Norfolk's entrepreneurial future.
            </div>
