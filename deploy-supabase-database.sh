...
# BettaDayz PBBG Supabase Database Deployment
# URL: https://btcfpizydmcdjhltwbil.supabase.co

SUPABASE_URL="https://btcfpizydmcdjhltwbil.supabase.co"
SUPABASE_PROJECT_ID="btcfpizydmcdjhltwbil"
JWT_SECRET="9=N6H//qQ]?g+BDV"

echo "🗄️ BettaDayz PBBG Supabase Database Setup"
echo "========================================="
...
# Create the complete database deployment script
cat > deploy-to-supabase.sql << 'EOF'
...
echo ""
echo "✅ Database deployment script created: deploy-to-supabase.sql"
echo ""
echo "🌐 Manual Deployment Options:"
echo ""
echo "Option 1: Supabase Dashboard"
echo "1. Go to: https://supabase.com/dashboard/project/btcfpizydmcdjhltwbil"
echo "2. Navigate to SQL Editor"
echo "3. Copy and paste the content from deploy-to-supabase.sql"
echo "4. Click 'Run' to execute the schema"
echo ""
echo "Option 2: Using psql (if you have database password)"
echo "psql -h db.btcfpizydmcdjhltwbil.supabase.co -p 5432 -d postgres -U postgres -f deploy-to-supabase.sql"
echo ""
...
echo "JWT Secret: $JWT_SECRET"
echo ""
echo "📊 After deployment, your database will have:"
echo "- ✅ Complete PBBG schema (8 tables)"
echo "- ✅ Game mechanics functions"
echo "- ✅ Sample quests and guild"
